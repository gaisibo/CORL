...
declare -a experience=('recursion' 'coverage' 'random_episode' 'max_match_mean' 'max_reward_mean' 'max_model_mean' 'random_transition' 'max_match' 'max_reward' 'max_model')
declare -a short_experience=('r__' 'c__' 're_' 'mpm' 'mrm' 'mdm' 'rt_' 'mp_' 'mr_' 'md_')
declare -a generate_type=('none')
declare -a short_generate=('n')
