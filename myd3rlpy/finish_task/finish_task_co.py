...
def finish_task_co(dataset_num, task_nums, dataset, original, network, indexes_euclid, real_action_size, topk, device, for_ewc=False):
    ...
    while len(start_indexes) != 0:
        ...
        near_indexes, _, _ = similar_phi(start_observations, start_actions, near_observations, near_actions, network._impl._phi, indexes_euclid[start_indexes], topk=topk)
