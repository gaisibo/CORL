...
from d3rlpy.algos.qlearning.base import AlgoBase
from d3rlpy.algos.qlearning.sac import SAC
    ...
    * TD3 updates the policy function after several Q function updates in order
    ...
    def _create_impl(
        ...
        if self._impl_name == 'sac':
            from myd3rlpy.algos.torch.st_sac_impl import STImpl
        elif self._impl_name == 'sacn':
            from myd3rlpy.algos.torch.st_sacn_impl import STImpl
        elif self._impl_name == 'edac':
            from myd3rlpy.algos.torch.st_edac_impl import STImpl
