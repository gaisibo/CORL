...
from .base import AlgoBaseMI
from .dqn import DoubleDQNMI
from .torch.cql_impl import CQLMIImpl


class CQLMI(AlgoBaseMI):
    ...
    def _create_impl(
            self, observation_shape: Sequence[int], action_size: int, task_id_size: int
    ) -> None:
        self._impl = CQLMIImpl(
